...
let users = [
  { id:1, name:"Dra. María González", email:"admin@moga.cl", password:"admin123", role:"admin", phone:"+56 9 1234 5678", rut:null, avatar:"MG" },
  { id:2, name:"Dr. Carlos Pérez",    email:"vet@moga.cl",   password:"vet123",   role:"vet",   phone:"+56 9 8765 4321", rut:null, avatar:"CP" },
  { id:3, name:"Ana Torres",          email:"ana@email.cl",  password:"123456",   role:"client",phone:"+56 9 1111 2222", rut:"12.345.678-9" },
  { id:4, name:"Pedro Soto",          email:"pedro@email.cl",password:"123456",   role:"client",phone:"+56 9 3333 4444", rut:"9.876.543-2" },
];
let pets = [
  { id:1, name:"Luna",  species:"Perro", breed:"Labrador Dorado",  age:3, weight:25.5, color:"Dorado",        gender:"Hembra", chip:"985141002123456", ownerId:3 },
  { id:2, name:"Michi", species:"Gato",  breed:"Siamés",           age:5, weight:4.2,  color:"Blanco/Café",   gender:"Macho",  chip:"985141009876543", ownerId:3 },
  { id:3, name:"Rocky", species:"Perro", breed:"Bulldog Francés",  age:2, weight:12.0, color:"Atigrado",      gender:"Macho",  chip:"985141005432198", ownerId:4 },
  { id:4, name:"Nala",  species:"Perro", breed:"Golden Retriever", age:4, weight:28.0, color:"Dorado oscuro", gender:"Hembra", chip:"985141001357924", ownerId:4 },
];
let records = [

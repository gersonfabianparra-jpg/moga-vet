...
// Detecta ruta de reserva pública: /#/reservar/TENANT_ID
function getPublicBookingTenant() {
  const hash = window.location.hash; // e.g. "#/reservar/moga-clinic"
  if (hash.startsWith("#/reservar/")) {
    return hash.replace("#/reservar/", "").split("?")[0].trim() || null;
  }
  return null;
}
